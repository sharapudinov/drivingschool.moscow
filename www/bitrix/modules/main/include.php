...
/*ZDUyZmZMmJhZWI2MTUzODhkZWYwNjA2Zjk4YzU3OWE5MWIwNjQ=*/$GLOBALS['____2050771909']= array(base64_decode('ZG'.'V'.'ma'.'W'.'5l'));if(!function_exists(__NAMESPACE__.'\\___1647288855')){function ___1647288855($_163250031){static $_680027154= false; if($_680027154 == false) $_680027154=array('RU5'.'DT'.'0R'.'F',''.'WQ==');return base64_decode($_680027154[$_163250031]);}};class CBXFeatures{ public static function IsFeatureEnabled($_80548904){ return true;} public static function IsFeatureEditable($_80548904){ return true;} public static function SetFeatureEnabled($_80548904, $_438074424= true){} public static function SaveFeaturesSettings($_1919852283, $_1928235928){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_933305650){} public static function ModifyFeaturesSettings($_933305650, $_1214084437){} public static function IsFeatureInstalled($_80548904){ return true;}} $GLOBALS['____2050771909'][0](___1647288855(0), ___1647288855(1));/**/			//Do not remove this
